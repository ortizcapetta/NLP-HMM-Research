...
# print("If we have just seen 'PP', the probability of 'NN' is", cpd_tags["PP"].prob("NN"))
# print("If we have just seen 'PP', the probability of 'VB' is", cpd_tags["PP"].prob("VB"))
print("If we have just seen 'AT', the probability of 'NN' is", cpd_tags["AT"].prob("NN"))
print("If we have just seen 'AT', the probability of 'PP' is", cpd_tags["AT"].prob("PP"))
...
prob_tagsequence = cpd_tags["START"].prob("AT") * cpd_tagwords["AT"].prob("The") * \
                   cpd_tags["AT"].prob("NN") * cpd_tagwords["NN"].prob("chicken") * \
                   cpd_tags["NN"].prob("BE") * cpd_tagwords["BE"].prob("is") * \
                   cpd_tags["BE"].prob("JJ") * cpd_tagwords["JJ"].prob("ready") * \
                   cpd_tags["JJ"].prob("TO") * cpd_tagwords["TO"].prob("to") * \
                   cpd_tags["TO"].prob("VB") * cpd_tagwords["VB"].prob("eat") * \
                   cpd_tags["VB"].prob("END")

print("The probability of the tag sequence 'START AT NN VB JJ TO VB END' for 'The chicken is ready to eat' is:", prob_tagsequence)

prob_tagsequence = cpd_tags["START"].prob("AT") * cpd_tagwords["AT"].prob("The") * \
                   cpd_tags["AT"].prob("PP") * cpd_tagwords["PP"].prob("chicken") * \
                   cpd_tags["PP"].prob("BE") * cpd_tagwords["BE"].prob("is") * \
                   cpd_tags["BE"].prob("JJ") * cpd_tagwords["JJ"].prob("ready") * \
                   cpd_tags["JJ"].prob("TO") * cpd_tagwords["TO"].prob("to") * \
                   cpd_tags["TO"].prob("VB") * cpd_tagwords["VB"].prob("eat") * \
                   cpd_tags["VB"].prob("END")
